...
class ConstellationController extends Controller
{
    ...
    public function store(StoreRequest $request){
        ...
        return redirect()->route('admin.constellation.index')->with('success','Create constellation successfully');
    }
    ...
    public function update(UpdateRequest $request, $id){
        ...
        return redirect()->route('admin.constellation.index')->with('success','Edit constellation successfully');
    }

    public function delete($id){
        $data_delete = DB::table('constellations')->where('id',$id)->first();
        ...
        return redirect()->route('admin.constellation.index')->with('success', 'Delete constellation successfully');
    }
}
