        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body demo-vertical-spacing demo-only-element">
                    ...
                    <div class="input-group">
                        <textarea type="text" class="form-control" name="content" placeholder="Content">{{ $news->content }}</textarea>
                    </div>
                    ...
                    <div class="input-group">
                        <img src="{{asset('images/'.$news->image)}}" width="200">
                    </div>
